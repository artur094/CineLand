 ...
 * @author ivanmorandi
 */
public class PasswordDimenticataFilter implements Filter {
    ...
    private void doBeforeProcessing(RequestWrapper request, ResponseWrapper response)
        ...
        if (debug) {
            log("PasswordDimenticataFilter:DoBeforeProcessing");
        }
    ...
    private void doAfterProcessing(RequestWrapper request, ResponseWrapper response)
            throws IOException, ServletException {
        if (debug) {
            log("PasswordDimenticataFilter:DoAfterProcessing");
        }
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        if (debug) {
            log("PasswordDimenticataFilter:doFilter()");
        }
        ...
        if(code == null)
        {
            ...
            try{
                ...
                String email = dbm.getEmailFromCodeForForgottenPassword(code);
                if(email.equals(""))
                {
                    error = true;
                }
            ...
            {
                throw new ServletException("Server Internal Error");
            }
        }
        if(error)
        {
    ...
    public void init(FilterConfig filterConfig) {        
        ...
        if (filterConfig != null) {
            if (debug) {                
                log("PasswordDimenticataFilter: Initializing filter");
            }
        }
    }
    ...
    public String toString() {
        if (filterConfig == null) {
            return ("PasswordDimenticataFilter()");
        }
        StringBuffer sb = new StringBuffer("PasswordDimenticataFilter(");
    ...
    class RequestWrapper extends HttpServletRequestWrapper {
        ...
        public void setParameter(String name, String[] values) {
            if (debug) {
                System.out.println("PasswordDimenticataFilter::setParameter(" + name + "=" + values + ")" + " localParams = " + localParams);
            }
        ...
        public String getParameter(String name) {
            if (debug) {
                System.out.println("PasswordDimenticataFilter::getParameter(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public String[] getParameterValues(String name) {
            if (debug) {
                System.out.println("PasswordDimenticataFilter::getParameterValues(" + name + ") localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Enumeration getParameterNames() {
            if (debug) {
                System.out.println("PasswordDimenticataFilter::getParameterNames() localParams = " + localParams);
            }
            if (localParams == null) {
        ...
        public Map getParameterMap() {
            if (debug) {
                System.out.println("PasswordDimenticataFilter::getParameterMap() localParams = " + localParams);
            }
            if (localParams == null) {
