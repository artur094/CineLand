...
public class AdminFilter implements Filter {
    ...
    public void doFilter(ServletRequest request, ServletResponse response,
        ...
        //Prendo l'utente dalla session
        //Se questo è null --> errore
        //Se invece è definito, per sicurezza prendo le info dal DB
        //E controllo se è un admin, e se è stato definito admin dal controller
        //Se si, allora procede, altrimenti --> errore
        boolean procedi = false;
        try{
            DBManager dbm = DBManager.getDBManager();
            Utente utente = (Utente)session.getAttribute("user");
            if(utente == null)
                throw new ServerException("Accesso non autorizzato");
            Utente utente_vero = dbm.getUtente(utente.getId());
            if(utente_vero.getRuolo().equals("admin"))
            {
        ...
        {
            throw new ServletException("Errore interno Server");
        }
